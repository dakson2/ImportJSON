 ...
 "Found_positions_append": [
  {
   ...
   "Availability status": "Verified live 25/09/2026 on employer Breezy; published 21/09/2026; one copy only, no older duplicate. Full text read: no cloaking/evasion terms.",
   "Fit score": 94,
   "Priority": "A - Primary / Apply",
